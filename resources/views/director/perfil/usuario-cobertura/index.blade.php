...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1>Asignar personal para la cobertura: {{ $coberturas->titulo }}</h1>
        </div>

        <div class="row">
            <div class="card">
                <div class="card-body">
                    <h5>Lista de personal activo</h5>
                    <div class="row" style="margin: 2% 0% 2% 0%;">
                        <div class="d-grid gap-2 col-12">
                            <form action="{{ route('director.usuario-cobertura.store') }}" method="POST" id="formElement"
                                name="f1">
                                @csrf
                                                        ...
                                                        @foreach ($usuarios as $usuario)
                                                            <tr>
                                                                ...
                                                                <td class="small-padding"
                                                                    style="text-align:center; padding-bottom: 3%;">
                                                                    <input class="form-check-input " type="checkbox"
                                                                        value="{{ $usuario->id }}" id="flexCheckDefault"
                                                                        name="usuario[]">
                                                                </td>
                                                            </tr>
                                                        @endforeach
...
<style>
     .form-check-input {
        ...
        height: 30px; /* Ajusta la altura según tus necesidades */
                                    ...
                                    <input type="hidden" value="{{ $coberturas->id }}" name="usuario_cobertura"></input>
                                </div>
                                <div class="row">
